...
(function (BLU) {
    /**
     * BLUEPRINT Global Context
     */
    let RunContext;
    (function (RunContext) {
        let Type;
        (function (Type) {
            Type["template"] = "TEMPLATE_CONTEXT";
            Type["chain"] = "CHAIN_CONTEXT";
        })(Type = RunContext.Type || (RunContext.Type = {}));
    })(RunContext = BLU.RunContext || (BLU.RunContext = {}));
    /**
     * BLUEPRINT Item
     */
    let Item;
