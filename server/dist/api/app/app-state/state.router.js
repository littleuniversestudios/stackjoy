...
exports.stateRouter = express_1.Router();
const appStateService = new state_service_1.StateService();
/**
 * Main app state
 */
exports.stateRouter.get('/main', route_validation_1.validateRequest(appStateRules.forLIST), route_handler_1.handleRoute(async (req, res, next) => {
    const result = appStateService.getMainState();
    result.error ? next(result.error) : res.json(result.data);
}));
exports.stateRouter.put('/main', route_validation_1.validateRequest(appStateRules.forPUT), route_handler_1.handleRoute(async (req, res, next) => {
