...
class FunctionModel {
    ...
    init() {
        var _a;
        this.setPaths();
        this.config = Object.assign({}, FunctionModel.defaultConfig, (_a = blu_utils_model_1.BLUUtils.loadJSONFile(this.paths.config)) !== null && _a !== void 0 ? _a : {});
    ...
    static createFunction(parentPath, name, contents, description = '', parent) {
        ...
        return FunctionModel.storeFunction(parentPath, functionId, name, contents, description, parent);
    }
    static newId() {
    ...
    static storeFunction(parentPath, functionId, name, contents, description = '', parent) {
        ...
        try {
            ...
            fs_extra_1.writeJSONSync(path_1.join(functionPath, 'config.json'), Object.assign({}, FunctionModel.defaultConfig, { name, description }));
            fs_1.writeFileSync(path_1.join(functionPath, 'function.js'), contents);
            return { error: null, data: { success: true, function: new FunctionModel(functionId, parent) } };
        }
        catch (error) {
