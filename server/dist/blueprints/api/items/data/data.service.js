...
class DataService {
    ...
    getModelsFromCurrentEnvironment() {
        return { error: null, data: globals_1.APP_ENVIRONMENT.getBlueprints().getDataMembers(blu_interface_1.BLU.Data.Type.model) };
    }
    getInputsFromCurrentEnvironment() {
        return { error: null, data: globals_1.APP_ENVIRONMENT.getBlueprints().getDataMembers(blu_interface_1.BLU.Data.Type.input) };
    }
    getSchemasFromCurrentEnvironment() {
        return { error: null, data: globals_1.APP_ENVIRONMENT.getBlueprints().getDataMembers(blu_interface_1.BLU.Data.Type.schema) };
    }
    /**
     * GET ANY Environment Data Members
     */
    getModelsByEnvironmentId(environmentId) {
        const blueprints = globals_1.APP.getEnvironmentById(environmentId).getBlueprints();
