...
exports.functionRouter.post('/duplicate/:functionId', route_validation_1.validateRequest(templateRules.forDUPLICATE), route_handler_1.handleRoute(async (req, res, next) => {
