...
const args_1 = require("./start/args");
 ...
 */
const cmdLineArgs = (0, args_1.parseArgs)();
...
const server = app.listen(port, async () => {
    ...
    (0, globals_1.initStackjoy)();
    const codebasePath = (_a = process.env.CODEBASE_PATH) !== null && _a !== void 0 ? _a : process.cwd();
    globals_1.APP_SERVICE.init(codebasePath);
    // handle command line arguments and .stackjoy.json file
    await (0, start_1.beforeServerStart)(cmdLineArgs);
    // for dev purpose only
    await (0, auto_login_1.autoLogin)();
    if (process.send) {
